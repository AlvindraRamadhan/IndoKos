    ...
    return ChoiceChip(
      ...
      onSelected: (selected) {
        if (selected) {
          ...
          provider.filterKos(provider.searchQuery, type);
        }
      },
          ...
          builder: (context, kosProvider, child) {
            ...
            return ListView(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.fromLTRB(16, 16, 16, 8),
                  child: Text("Ditemukan ${filteredKos.length} kos",
                      style: TextStyle(color: Colors.grey[600])),
                ),
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          ...
                          const Text("Tidak ada kos ditemukan",
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.bold)),
                          const SizedBox(height: 4),
                          Text("Coba ubah filter pencarian Anda",
                              style: TextStyle(color: Colors.grey[600])),
                        ],
                      ),
                    ),
